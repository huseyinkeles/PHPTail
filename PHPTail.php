...
class PHPTail {
	...
	public function __construct($log, $defaultUpdateTime = 2000, $maxSizeToLoad = 2097152) {
		...
		$this->setRefreshFileName() ;
	}

	public function setRefreshFileName( $fileName = 'Log.php' )
	{
		$this->refreshFileName = $fileName ;
	}

	public function getRefreshFileName()
	{
		return $this->refreshFileName ;
	}
